...
This is the local architect-role skill for drawing and reviewing **系统功能架构图** in the **概要设计** stage.
...
- 网页嵌入、交互式功能图、动态高亮、高精度输出场景，使用 SVG / HTML 路线；在支持 SVG / HTML 产图或渲染能力的宿主中，可映射到相应的架构图生成器或可视化组件
