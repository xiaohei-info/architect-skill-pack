...
This skill serves the architect role's **技术方案设计 → 概要设计 方法论 skill**.
...
|      |        | 这些功能是如何分层的？                                                                                                                                               | 给出功能架构图，示例如下： ![](../../../../illustrative-source/软件架构设计的生命周期-1779158567049.png)                                                                                                            |
...
|      |        | 整体系统架构是什么样的？模块如何协作、边界如何划分？ <br><br>_子系统划分与联动、系统内部的实现方式、与外部系统的依赖关系与交互_ _、各个模块功能、职责与分层明细_ _把协作方的系统也考虑进来，当做不可靠的外部依赖设计_                                       | 系统架构图，示例如下： <br>![](../../../../illustrative-source/软件架构设计的生命周期-1779158607112.png)                                                                                                          |
