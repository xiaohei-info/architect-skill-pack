...
All packaged skills originated from the private source category:
- `software-development`

## Public bundle mapping
...
The public repo groups skills by browsing bundle. Runtime install paths still map back to the original host category.
